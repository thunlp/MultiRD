...
def main(mode):
    ...
    if len(label_list_wd)>2000:
        print('Test on 2000: ')
        test_accu_1, test_accu_10, test_accu_100, median, variance = evaluate_test(label_list_wd[:2000], pred_list_wd[:2000])
        print('test_accu(1/10/100): %.2f %.2F %.2f %.1f %.2f'%(test_accu_1, test_accu_10, test_accu_100, median, variance))
        print('Test on 200: ')
        test_accu_1, test_accu_10, test_accu_100, median, variance = evaluate_test(label_list_wd[2000:2200], pred_list_wd[2000:2200])
        print('test_accu(1/10/100): %.2f %.2F %.2f %.1f %.2f'%(test_accu_1, test_accu_10, test_accu_100, median, variance))
        print('Test on 272: ')
        test_accu_1, test_accu_10, test_accu_100, median, variance = evaluate_test(label_list_wd[2200:], pred_list_wd[2200:])
        print('test_accu(1/10/100): %.2f %.2F %.2f %.1f %.2f'%(test_accu_1, test_accu_10, test_accu_100, median, variance))
